...
export const metadata: Metadata = {
	...
	description: `Full-stack Product Engineer with ${experience}+ years of experience in building products using TypeScript and a strong passion for UX and interaction design.`,
	category: "portfolio",
	openGraph: {
		type: "website",
